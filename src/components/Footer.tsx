        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 pb-12 border-b border-[#2C4E3B]">
          ...
          <div className="md:col-span-2 space-y-3">
            ...
            <p className="text-xs sm:text-sm text-[#A2B3A7] leading-relaxed max-w-md">
              Aplikasi Berbasis Cloud atau SaaS (Software as a Service) untuk pencatatan jurnal mengajar harian, presensi siswa, sistem poin keaktifan, dan rekap data pembelajaran — dengan estetika buku catatan klasik bergaris dan kenyamanan teknologi cloud modern.
            </p>
        ...
        <div className="pt-6 flex flex-col sm:flex-row items-center justify-between text-xs text-[#7A8C7F] gap-3">
          <div>
            ...
            <img
             ...
             alt="Dimas BN"
             className="w-9 h-9 rounded-full inline-block align-middle mx-1 my-2"
             /> 
              Dimas BN
            </a>
          </div>
