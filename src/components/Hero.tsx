...
export const Hero: React.FC<HeroProps> = ({ onOpenProjectorDemo }) => {
  ...
  useEffect(() => {
    ...
    }, 3500); // jeda tiap pergantian kata 3,5 detik
  ...
  return (
      <section className="relative pt-8 pb-16 md:pt-14 md:pb-24 overflow-hidden">
        ...
        <div className="hero-blob-a absolute top-0 left-1/2 w-[800px] h-[350px] bg-[#3E6B52]/22 blur-[120px] rounded-full pointer-events-none" />
        <div className="hero-blob-b absolute top-10 left-[15%] w-[420px] h-[420px] bg-[#2C4E3B]/30 blur-[90px] rounded-full pointer-events-none" />
        <div className="hero-blob-c absolute top-24 right-[10%] w-[380px] h-[380px] bg-[#508467]/22 blur-[85px] rounded-full pointer-events-none" />
